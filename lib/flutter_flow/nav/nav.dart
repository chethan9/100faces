...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/scanning',
          requireAuth: true,
          builder: (context, params) => const ScanningWidget(),
        ),
        FFRoute(
          name: 'Prediction',
          path: '/prediction',
          requireAuth: true,
          builder: (context, params) => const PredictionWidget(),
        ),
        FFRoute(
          name: 'Dashboard',
          path: '/dashboard',
        ...
        FFRoute(
          name: 'DataManagement',
          path: '/dataManagement',
          builder: (context, params) => const DataManagementWidget(),
        ),
        FFRoute(
          name: 'Predictions',
          path: '/predictions',
          builder: (context, params) => const PredictionsWidget(),
        ),
        FFRoute(
          name: 'users',
          path: '/users',
        ...
        FFRoute(
          ...
          path: '/predictionsList',
          requireAuth: true,
          asyncParams: {
            'userPredict':
                getDoc(['user_prediction'], UserPredictionRecord.fromSnapshot),
          },
          builder: (context, params) => PredictionsListWidget(
            userPredict: params.getParam('userPredict', ParamType.Document),
          ),
        ),
        FFRoute(
          ...
          requireAuth: true,
          builder: (context, params) => const PredictionDetailsWidget(),
        ),
        FFRoute(
          name: 'EditProfile',
          path: '/editProfile',
        ...
        FFRoute(
          name: 'profiledadas',
          path: '/profiledadas',
          builder: (context, params) => const ProfiledadasWidget(),
        )
