...
import '/frontend/others/image_upload_error/image_upload_error_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:provider/provider.dart';
import 'selfiescreen_model.dart';
export 'selfiescreen_model.dart';

class SelfiescreenWidget extends StatefulWidget {
  const SelfiescreenWidget({super.key});

  @override
  _SelfiescreenWidgetState createState() => _SelfiescreenWidgetState();
}
                      ...
                      children: [
                        RichText(
                          ...
                          text: TextSpan(
                            children: [
                              TextSpan(
                                text: 'Avoid these types of pictures',
