...
import 'changepassworduser_model.dart';
export 'changepassworduser_model.dart';

class ChangepassworduserWidget extends StatefulWidget {
  const ChangepassworduserWidget({super.key});

  @override
  _ChangepassworduserWidgetState createState() =>
      _ChangepassworduserWidgetState();
}

class _ChangepassworduserWidgetState extends State<ChangepassworduserWidget> {
  late ChangepassworduserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChangepassworduserModel());
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Click on the send button, We will send a reset password link to your email for you to update it.',
